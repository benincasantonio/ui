    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            Your article will be visible to all users once published. You can still edit it after
            publishing.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
  ...
  render: function ControlledStory() {
    ...
    return (
      <div className="flex flex-col gap-4 items-center">
        <AlertDialog open={open} onOpenChange={setOpen}>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This dialog's state is controlled by React state. The parent component manages when
                it opens and closes.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
        ...
        {confirmed && <p className="text-sm text-green-600">✓ Action confirmed successfully!</p>}
      </div>
    );
  },
  play: async ({ canvasElement, step }) => {
    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            This example demonstrates using different button sizes in the alert dialog footer.
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
